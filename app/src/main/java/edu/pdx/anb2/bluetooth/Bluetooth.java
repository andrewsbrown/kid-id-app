...
/**
 * Borrowed from https://github.com/samina-khan/BeBoggled
 */
...
public class Bluetooth {
    private static final String TAG = "KidIdService";
    ...
    public synchronized void start() {
        ...
        // Start the thread to read on a BluetoothServerSocket
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                Log.e(TAG, "Socket Type: " + mSocketType + "read() failed", e);
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.e(TAG, "Failed while reading Bluetooth", e);
                connectionLost();
                Bluetooth.this.start();
            }
        }
